...
class KsDef:
  ...
  def write(self, oprot):
    ...
    if self.strategy_options != None:
      ...
      for kiter112,viter113 in self.strategy_options.items():
...
class CqlMetadata:
      ...
      if fid == 1:
        if ftype == TType.MAP:
          ...
          for _i126 in xrange(_size122):
            ...
            self.name_types[_key127] = _val128
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
        if ftype == TType.MAP:
          ...
          for _i133 in xrange(_size129):
            ...
            self.value_types[_key134] = _val135
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 3:
  ...
  def write(self, oprot):
    ...
    if self.name_types != None:
      ...
      for kiter136,viter137 in self.name_types.items():
    ...
    if self.value_types != None:
      ...
      for kiter138,viter139 in self.value_types.items():
